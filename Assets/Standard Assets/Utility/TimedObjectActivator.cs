...
using UnityEngine;
using UnityEngine.SceneManagement;  // Add this namespace for SceneManager functionality
...
namespace UnityStandardAssets.Utility
{
    public class TimedObjectActivator : MonoBehaviour
    {
        ...
        private IEnumerator ReloadLevel(Entry entry)
        {
            ...
            // Replace the obsolete Application.LoadLevel with SceneManager.LoadScene
