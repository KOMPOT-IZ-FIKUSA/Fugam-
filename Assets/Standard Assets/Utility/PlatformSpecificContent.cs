...
#if UNITY_EDITOR
        // Implement IActiveBuildTargetChanged interface
        public int callbackOrder => 0; // Required for the interface

        // This method will be called when the active build target changes
        public void OnActiveBuildTargetChanged(BuildTarget previousTarget, BuildTarget newTarget)
        {
            Update();
        }

        // Call Update when any relevant changes occur
        private void Update()
        {
            CheckEnableContent();
        }
